                                ...
                                itemBuilder:
                                  ...
                                  if (double.parse(bmi) <= 18.5) {
                                    return perMealWidget(
                                      ...
                                      double.parse(bmi) <= 25) {
                                    return perMealWidget(
                                      mealCal: breakfastNormalKcal[position],
                                    ...
                                    return perMealWidget(
                                      ...
                                      mealCal: breakfastHighKcal[position],
                                      minusFunction: () {
                                        setState(() {
                                          yourIntake -
                                                      breakfastHighKcal[
                                ...
                                itemBuilder:
                                  ...
                                  if (double.parse(bmi) <= 18.5) {
                                    return perMealWidget(
                                      ...
                                      addFunction: () {
                                        setState(() {
                                          yourIntake += snack1LowKcal[position];
                                        });
                                      },
                                    );
                                  } else if (double.parse(bmi) > 18.5 &&
                                ...
                                itemBuilder:
                                  ...
                                  if (double.parse(bmi) <= 18.5) {
                                    return perMealWidget(
                                      ...
                                      minusFunction: () {
                                        setState(() {
                                          yourIntake - lunchLowKcal[position] >=
                                                  0
                                              ? yourIntake -=
                                    ...
                                    return perMealWidget(
                                      ...
                                      addFunction: () {
                                        setState(() {
                                          yourIntake += lunchHighKcal[position];
                                        });
                                      },
                                    );
                                  }
                                ...
                                itemBuilder:
                                  ...
                                  if (double.parse(bmi) <= 18.5) {
                                    return perMealWidget(
                                      ...
                                      addFunction: () {
                                        setState(() {
                                          yourIntake += snack2LowKcal[position];
                                        });
                                      },
                                    );
                                  } else if (double.parse(bmi) > 18.5 &&
                                ...
                                itemBuilder:
                                  ...
                                  if (double.parse(bmi) <= 18.5) {
                                    return perMealWidget(
                                      ...
                                      addFunction: () {
                                        setState(() {
                                          yourIntake += dinnerLowKcal[position];
                                        });
                                      },
                                    );
                                  } else if (double.parse(bmi) > 18.5 &&
